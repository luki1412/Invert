"friends/ChatRoomDlg.res"
{
	...
	styles
	{
		...
		render_bg
			{
						 0="gradient( x0 +1, y0, x1 -1, y1, almostblack, almostblack )"
			}
		}
	...
	layout
	{
		...
		place { control="TextEntry" region=bottomrow end-right="EmoticonButton" height=42 width=max margin-right=8 margin-left=8 margin-top=8 }
